...
const ConfirmationPopup = (props) => {
    const { isOpen, closePopup, handleConfirm, desc, header } = props;
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div
                className={`bg-white rounded-lg shadow-lg transform transition-all duration-300 ease-in-out scale-100 opacity-100 p-6 w-96
