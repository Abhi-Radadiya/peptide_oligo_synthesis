            ...
            <div className="flex flex-row w-full items-start justify-between border border-neutral-300 rounded-2xl shadow-md py-4 px-6 mb-6">
                <div className="max-w-[615px] w-full">
                    ...
                    <AmediteSection
                        ...
                        title="Capping B"
                    />
                    <AmediteSection names={{ solvent: "n_cappingWashSolvent", volume: "n_cappingWashVolume", xFactor: "n_cappingWashXFactor" }} title="Wash setting" />
                </div>

                <WasteColumnSelection control={control} name="n_cappingWaste" />
            </div>
        </>
    );
}
