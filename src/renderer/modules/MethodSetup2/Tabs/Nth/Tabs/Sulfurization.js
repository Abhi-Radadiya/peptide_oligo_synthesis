        ...
        <>
            <div className="flex flex-row w-full items-start justify-between border border-neutral-300 rounded-2xl shadow-md py-4 px-6 mb-6">
                <div className="max-w-[615px] w-full">
                    ...
                    <RadioSection radioName="n_sulfurizationConductivityEnable" title="Conductivity" control={control} checkName="n_sulfurizationCheck" />
                </div>

                <WasteColumnSelection name="n_sulfurizationWaste" control={control} />
            </div>
        </>
    );
}
