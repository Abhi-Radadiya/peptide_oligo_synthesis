        ...
        <>
            <div className="flex flex-row w-full items-start justify-between border border-neutral-300 rounded-2xl shadow-md py-4 px-6 mb-6">
                <div className="max-w-[615px] w-full">
                    ...
                    <AmediteSection names={{ solvent: "n_deSolvent", volume: "n_deVolume", xFactor: "n_deXFactor" }} className="mb-4 pb-4 border-b border-neutral-300" />
                    <AmediteSection
                    ...
                    <RadioSection title="UV Setting" radioName="n_deUVEnable" checkName="n_deCheck" />
                </div>

                <WasteColumnSelection name="n_deWaste" control={control} />
            </div>
        </>
    );
}
