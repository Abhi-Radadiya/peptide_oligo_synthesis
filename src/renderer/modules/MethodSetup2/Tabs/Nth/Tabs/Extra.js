                ...
                <div className="max-w-[615px] w-full">
                    ...
                    <div className="flex flex-row items-center justify-between mb-4">
                        <div className="flex flex-row items-center gap-6 w-full  justify-between">
                            <SelectionController width={200} menuItem={testSolvents} control={control} name="extra_solvent" placeholder="Select Solvent" />
                            ...
                            <p className="w-full max-w-[220px] border border-neutral-300 rounded-lg px-4 py-2">
                                ...
                                <span>{watch("extra_solvent")?.flowRate ?? "___  "} ml/min</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-row items-center gap-6 justify-between border-b border-neutral-300 pb-4 mb-4">
                        ...
                        <InputField name="extra_x_factor" width="w-[220px]" wrapperClassName=" max-w-[220px]" control={control} type="number" placeholder="Enter X Factor" />
                    </div>
                    ...
                    <div className="flex flex-row items-center justify-between my-4">
                        <div className="flex flex-row items-center gap-6 w-full justify-between">
                            <SelectionController width={200} menuItem={testSolvents} control={control} name="extra_wash_solvent" placeholder="Select Solvent" />

                            <p className="w-full max-w-[220px] border border-neutral-300 rounded-lg px-4 py-2 shadowd-lg">
                                <span className="font-bold text-base mr-2">Flow Rate : </span>
                                <span>{watch("extra_wash_solvent")?.flowRate ?? "___  "} ml/min</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-row items-center gap-6 justify-between">
                        <span className="font-bold text-neutral-600">X Factor</span>
                        <InputField name="extra_wash_x_factor" width="w-[220px]" control={control} type="number" placeholder="Enter X Factor" />
                    </div>
                </div>

                <div className="flex flex-row w-full max-w-[260px] items-center gap-3">
                    <span className="font-bold text-base">Waste Column : </span>
                    <SelectionController isClearable={false} width={120} menuItem={wasteMenuItems} control={control} name="extra_waste" />
                </div>
            </div>
        </>
    );
