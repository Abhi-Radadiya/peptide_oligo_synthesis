...
const FileUploadFlyout = (props) => {
    const { setInputCmd, setFlyoutOpen, flyoutOpen } = props;
    ...
    return (
        <div className="relative bg-gray-50 p-0">
            <div className="fixed inset-0 bg-black bg-opacity-50 z-10" onClick={() => setFlyoutOpen(false)} />

            <div className={`fixed top-0 right-0 h-screen overflow-auto w-[50%] bg-white shadow-lg transition-transform duration-500 ease-in-out z-[11] translate-x-0`}>
